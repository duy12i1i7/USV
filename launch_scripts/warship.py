...
if len(sys.argv) < 7:
    print("Vui lòng nhập số lượng tàu, tọa độ x, y của tàu đầu tiên và tọa độ x, y của tàu thứ hai.")
    sys.exit(1)

# Lấy số lượng tàu từ tham số dòng lệnh
num_ships = int(sys.argv[1])

# Lấy tọa độ của tàu đầu tiên (x, y) và tọa độ của tàu thứ hai
x_first = float(sys.argv[2])
y_first = float(sys.argv[3])
yaw_first = float(sys.argv[4])

x_second = float(sys.argv[5])
y_second = float(sys.argv[6])
yaw_second = float(sys.argv[7])
